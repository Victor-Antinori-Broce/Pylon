...
declare module '$env/static/private' {
	...
	export const EFC_9348_344590478: string;
	...
	export const npm_package_dependencies__gremius_shared: string;
	export const npm_package_dependencies__tanstack_svelte_table: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies__gremius_shared: string;
		npm_package_dependencies__tanstack_svelte_table: string;
